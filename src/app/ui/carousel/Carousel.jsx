...
const Carousel = ({Data}) => {
    ...
    //! sets randomNbrs value to an array containing 5 different random numbers
    ...
    //! call randomNbrs Maker each time component is re mounted
    useEffect(() => {
    ...
    return (
        <div className='relative w-full max-sm:w-screen h-[300px] animate-slideUp max-sm:h-[200px]'>
            <div className={`${theme.textColor1} size-full border-b-[1px] border-[#2e1848] overflow-hidden`}>
                ...
                <div ref={sliderRef} className='w-full h-full flex flex-col flex-wrap p-6 gap-4 py-4 carousel'>
                    {
                        ...
                        Data.map((book) => {
                            return(
                                ...
                                <div className={`${theme.bgColor2} w-1/3 max-sm:w-full max-md:w-3/4 flex rounded-lg`}>
