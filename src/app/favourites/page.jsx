              ...
              <div className='flex w-full h-full bg-[#0f0f0f] rounded-lg overflow-hidden border-[1px] transition-all border-[#202020] '>
                ...
                <div className='w-2/3 h-full px-5 p-4'>
                  <div className='flex justify-between'>
                    ...
                    <button onClick={()=> dispatch(updateFavs(book))} className='h-fit px-4 py-1 rounded-full bg-violet-500'>Remove</button>
                  </div>
                  <hr className='my-4 opacity-10' />
                  <div className='flex flex-col gap-2 overflow-ellipsis'>
                    <div className='flex justify-between'> 
                      <div className=' font-light'>Your review - <span className='font-bold text-violet-500 ml-2'>5/5</span></div>
                      <Link href={`/shop/${book.id-1}`} className='h-fit px-4 py-1 bg-black rounded-full text-violet-500'>Edit</Link>
                    </div>
